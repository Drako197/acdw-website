...
export function EmailPreferencesPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const recaptchaResult = await getRecaptchaToken('email-preferences')
                        ...
                        >
                            ...
                            <div className="email-preferences-email-field">
                                ...
                                <input
                                    ...
                                    required
                                    className={`email-preferences-email-input ${emailError ? 'email-preferences-email-input-error' : ''}`}
                                    placeholder="your.email@example.com"
                                />
                                {emailError ? (
                                    <p className="email-preferences-email-error">{emailError}</p>
                                ) : (
                            ...
                            <div className="email-preferences-selection-section">
                                ...
                                <div className="email-preferences-options-list">
                                    ...
                                    <label className="email-preferences-option email-preferences-option-selectable">
                                        ...
                                        />
                                        <div className="email-preferences-option-content">
                                            <div className="email-preferences-option-title">Promotions & Offers</div>
                                            <div className="email-preferences-option-description">Special discounts, sales, and exclusive offers</div>
                                        </div>
                                    </label>
                                    ...
                                    <label className="email-preferences-option email-preferences-option-selectable">
                                        ...
                                        <div className="email-preferences-option-content">
                                            ...
                                            <div className="email-preferences-option-description">Industry tips, maintenance guides, and company news</div>
                                        </div>
                                    </label>
