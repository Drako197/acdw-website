            ...
            <div className="prose max-w-none">
              ...
              <ol className="list-decimal pl-6 space-y-3 text-gray-700">
                <li>
                  ...
                  or call us at <strong>(561) 654-5237</strong> to initiate a warranty claim.
                </li>
                <li>
            ...
            <div className="prose max-w-none">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-4">
                ...
                <p className="text-gray-700 mt-2 text-sm">
                  <strong>Note:</strong> Contact us at <a href="mailto:support@acdrainwiz.com" className="text-orange-600 hover:text-orange-700">support@acdrainwiz.com</a> or <strong>(561) 654-5237</strong> 
