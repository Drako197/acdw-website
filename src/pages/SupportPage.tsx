                ...
                <div className="support-content-section">
                    ...
                    <ol className="support-step-list">
                      <li className="support-step-item">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Measure and cut a section of your 3/4" PVC drain line to accommodate the AC Drain Wiz unit.</p>
                        </div>
                      </li>
                      <li className="support-step-item">
                        <span className="support-step-number">2</span>
                        <div>
                          <strong className="text-gray-900">Solvent-weld in place</strong>
                  ...
                  <div className="support-info-box">
                    <p className="support-info-text">
                      ...
                      <a href="tel:+15616545237" className="text-blue-600 hover:text-blue-700">(561) 654-5237</a>{' '}
                      or{' '}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside">
                          <li>Contact us at <a href="mailto:info@acdrainwiz.com" className="text-blue-600">info@acdrainwiz.com</a> or call (561) 654-5237</li>
